...
class QuizModel extends ChangeNotifier {
  int? _selectedAnswerIndex; // Indice de la respuesta seleccionada
  int _questionIndex = 0; // Indice de la pregunta actual
  int _score = 0; // Puntuación del usuario
  ...
  int? get selectedAnswerIndex =>
      _selectedAnswerIndex; // Getter para el índice de la respuesta seleccionada
  int get questionIndex =>
      _questionIndex; // Getter para el índice de la pregunta actual
  int get score => _score; // Getter para la puntuación del usuario
  List<Question> get questions =>
      _questions; // Getter para la lista de preguntas
  ...
  void goToNextQuestion() {
    // Avanza a la siguiente pregunta si hay más preguntas disponibles
    if (_questionIndex < _questions.length - 1) {
      _questionIndex++;
      _selectedAnswerIndex = null; // Resetea la respuesta seleccionada
    }
    notifyListeners();
  }
